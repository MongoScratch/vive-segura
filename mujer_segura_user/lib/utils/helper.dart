...
String validateEmail(String value) {
  ...
  if (!regex.hasMatch(value)){ return 'Ingresa un email valido'; }
  else{  return null; }
}
...
Widget _getCircularImageProvider(
  ...
  return Container(
    ...
    child: ClipOval(
      child: FadeInImage(
        fit: BoxFit.cover,
        placeholder: Image.asset('assets/images/placeholder.jpg', fit: BoxFit.cover, height: size, width: size).image,
        image: provider
      )
    ),
  );
