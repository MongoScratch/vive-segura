                      ...
                      child: MaterialButton(
                        ...
                        onPressed: () async {
                          if (_formKey.currentState.validate()) {
                            ...
                            dynamic result = await _authService.verifyPhone(context, '+52$_phoneNo');
                          }
                        },
                      ),
                    ),
    ...
    return Column(
      children: <Widget>[
        Align(
          ...
          child: IconButton(
            icon: Icon(Icons.keyboard_backspace, size: 25,),
        ...
        Padding(
          ...
          child: PinCodeTextField(
            ...
            pinTheme: PinTheme(
              selectedFillColor: Colors.red[100],
        ...
        SizedBox(height: 20,),
        isLoading ? SpinKitRing(color: Colors.pinkAccent) : Container(
          width: 120,
          padding: EdgeInsets.symmetric(vertical: 5),
          child: MaterialButton(
            padding: EdgeInsets.symmetric(vertical: 5),
